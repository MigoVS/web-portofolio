        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              Seorang mahasiswa Teknologi Proses Industri Petrokimia yang
              tertarik dalam pengembangan Front-End saya memiliki keahlian dibidang Political, Chemical Process, dan Business Saya berfokus pada
              menciptakan pengalaman digital yang menarik dan selalu berusaha
              memberikan solusi terbaik dalam setiap proyek. Kata ini yang selalu terpatri: Malas = Tertindas, Lambat = Tertinggal, Berhenti = Mati.
            </p>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="LINK CVVVVV" className="w-full">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
